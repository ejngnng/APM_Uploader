...
namespace ArduPilotUploader
{
    public class APMUploader
    {
        ...
        public APMUploader(string port, int baudrate)
        {
            self = this;
        ...
        public void __program(APMFirmware fw)
        {
        ...
        public void __verify_v3(APMFirmware fw)
        {
        ...
        public void currentChecksum(APMFirmware fw)
        {
            if (self.bl_rev < 3)
                return;
        ...
        public void upload(APMFirmware fw)
        {
            this.port.ReadTimeout = 1000; // 1 sec
